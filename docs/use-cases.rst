...
Since the SDK employed for the RS232 commands of KatanaLaserManager is propertary we cannot provide it, but it would connect to the RS232Device in a similar way as AAAOTFLaserManager.
