...
def test_scan_signals():
    ...
    with np.load(os.path.join(os.path.dirname(__file__), 'test_scan_expected.npz')) as data:
        np.testing.assert_allclose(fullsig['stageScanSignalsDict']['Stage_X'], data['Stage_X'])
        np.testing.assert_allclose(fullsig['stageScanSignalsDict']['Stage_Y'], data['Stage_Y'])
        np.testing.assert_allclose(fullsig['stageScanSignalsDict']['Stage_Z'], data['Stage_Z'])
