...
class DeckController(LiveUpdatedController):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.deck_definition = DeckConfig(self._setupInfo.deck["OpentronsDeck"])
    ...
    def connect_add_position(self):
        if isinstance(self._widget.add_btn, guitools.BetterPushButton):
            ...
            z = self._widget.current_z_focus if self._widget.current_z_focus is not None else self.positioner.position[
                "Z"]
