...
#define UTS100CC_BUILDER_VERSION_MAJOR  0
#define UTS100CC_BUILDER_VERSION_MINOR  9
#define UTS100CC_BUILDER_VERSION_BUGFIX 9
#define UTS100CC_BUILDER_VERSION_SUFFIX ""
#define UTS100CC_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_UTS100CC(device_t id)
{
  ...
  feedback_settings.CountsPerTurn = 7272;
  ...
  move_settings.Speed = 1650;
  move_settings.uSpeed = 0;
  move_settings.Accel = 6000;
  move_settings.Decel = 6000;
  move_settings.AntiplaySpeed = 1650;
  ...
  engine_settings.NomCurrent = 900;
  engine_settings.NomSpeed = 3300;
  ...
  engine_settings.Antiplay = 29454;
  ...
  edges_settings.LeftBorder = 25000;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 975000;
  ...
  control_settings.MaxSpeed[1] = 165;
  control_settings.MaxSpeed[2] = 1650;
  ...
  emf_settings.L = 0.005100000184029341;
  emf_settings.R = 2.5199999809265137;
  emf_settings.Km = 0;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {85, 84, 83, 49, 48, 48, 67, 67, 0, 45, 48, 54, 0, 45, 48, 52, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  gear_settings.ReductionIn = 44;
  gear_settings.ReductionOut = 16;
