...
#define UTS50CC_BUILDER_VERSION_MAJOR  0
#define UTS50CC_BUILDER_VERSION_MINOR  9
#define UTS50CC_BUILDER_VERSION_BUGFIX 9
#define UTS50CC_BUILDER_VERSION_SUFFIX ""
#define UTS50CC_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_UTS50CC(device_t id)
{
  ...
  edges_settings.LeftBorder = 12500;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 487500;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {85, 84, 83, 53, 48, 67, 67, 0, 0, 45, 48, 54, 0, 45, 48, 52, 0, 0, 0, 0, 0, 0, 0, 0};
