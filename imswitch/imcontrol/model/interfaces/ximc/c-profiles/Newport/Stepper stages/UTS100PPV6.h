...
#define UTS100PPV6_BUILDER_VERSION_MAJOR  0
#define UTS100PPV6_BUILDER_VERSION_MINOR  9
#define UTS100PPV6_BUILDER_VERSION_BUGFIX 9
#define UTS100PPV6_BUILDER_VERSION_SUFFIX ""
#define UTS100PPV6_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_UTS100PPV6(device_t id)
{
  ...
  home_settings.FastHome = 250;
  home_settings.uFastHome = 0;
  home_settings.SlowHome = 250;
  ...
  engine_settings.NomCurrent = 850;
  ...
  edges_settings.LeftBorder = -292;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 9208;
  ...
  emf_settings.L = 0.11299999803304672;
  emf_settings.R = 5.699999809265137;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {85, 84, 83, 49, 48, 48, 80, 80, 86, 54, 0, 54, 0, 45, 48, 52, 0, 0, 0, 0, 0, 0, 0, 0};
