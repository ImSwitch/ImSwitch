...
#define UTS150PPV6_BUILDER_VERSION_MAJOR  0
#define UTS150PPV6_BUILDER_VERSION_MINOR  9
#define UTS150PPV6_BUILDER_VERSION_BUGFIX 9
#define UTS150PPV6_BUILDER_VERSION_SUFFIX ""
#define UTS150PPV6_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_UTS150PPV6(device_t id)
{
  ...
  edges_settings.LeftBorder = -167;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 14083;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {85, 84, 83, 49, 53, 48, 80, 80, 86, 54, 0, 54, 0, 45, 48, 52, 0, 0, 0, 0, 0, 0, 0, 0};
