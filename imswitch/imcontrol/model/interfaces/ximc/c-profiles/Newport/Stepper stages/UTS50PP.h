...
#define UTS50PP_BUILDER_VERSION_MAJOR  0
#define UTS50PP_BUILDER_VERSION_MINOR  9
#define UTS50PP_BUILDER_VERSION_BUGFIX 9
#define UTS50PP_BUILDER_VERSION_SUFFIX ""
#define UTS50PP_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_UTS50PP(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {85, 84, 83, 53, 48, 80, 80, 0, 86, 54, 0, 54, 0, 45, 48, 52, 0, 0, 0, 0, 0, 0, 0, 0};
