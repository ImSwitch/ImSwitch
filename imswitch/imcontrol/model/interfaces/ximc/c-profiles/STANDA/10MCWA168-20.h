#ifndef __10MCWA168_20
#define __10MCWA168_20
...
#define 10MCWA168_20_BUILDER_VERSION_BUGFIX 10
#define 10MCWA168_20_BUILDER_VERSION_SUFFIX ""
#define 10MCWA168_20_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_10MCWA168_20(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {49, 48, 77, 67, 87, 65, 49, 54, 56, 45, 50, 48, 0, 45, 48, 52, 0, 0, 0, 0, 0, 0, 0, 0};
