#ifndef __8CMA42_2_4247
#define __8CMA42_2_4247
...
#define 8CMA42_2_4247_BUILDER_VERSION_MAJOR  0
#define 8CMA42_2_4247_BUILDER_VERSION_MINOR  9
#define 8CMA42_2_4247_BUILDER_VERSION_BUGFIX 10
#define 8CMA42_2_4247_BUILDER_VERSION_SUFFIX ""
#define 8CMA42_2_4247_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8CMA42_2_4247(device_t id)
{
  ...
  edges_settings.LeftBorder = -246;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 9406;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 67, 77, 65, 52, 50, 45, 50, 45, 52, 50, 52, 55, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  stage_settings.TravelRange = 50.79999923706055;
