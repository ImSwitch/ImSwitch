...
#define 8MAV_8_BC_BUILDER_VERSION_MAJOR  0
#define 8MAV_8_BC_BUILDER_VERSION_MINOR  9
#define 8MAV_8_BC_BUILDER_VERSION_BUGFIX 10
#define 8MAV_8_BC_BUILDER_VERSION_SUFFIX ""
#define 8MAV_8_BC_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MAV_8_BC(device_t id)
{
  ...
  edges_settings.LeftBorder = 3920;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 152880;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 65, 86, 45, 56, 45, 66, 67, 0, 50, 52, 55, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
