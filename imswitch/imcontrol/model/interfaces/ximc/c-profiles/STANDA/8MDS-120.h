...
#define 8MDS_120_BUILDER_VERSION_MAJOR  0
#define 8MDS_120_BUILDER_VERSION_MINOR  9
#define 8MDS_120_BUILDER_VERSION_BUGFIX 10
#define 8MDS_120_BUILDER_VERSION_SUFFIX ""
#define 8MDS_120_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MDS_120(device_t id)
{
  ...
  engine_settings.NomVoltage = 800;
  engine_settings.NomCurrent = 176;
  ...
  engine_settings.Antiplay = -29824;
  ...
  edges_settings.LeftBorder = 400;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 15600;
