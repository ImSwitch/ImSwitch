...
#define 8MFM_2_BUILDER_VERSION_MAJOR  0
#define 8MFM_2_BUILDER_VERSION_MINOR  9
#define 8MFM_2_BUILDER_VERSION_BUGFIX 10
#define 8MFM_2_BUILDER_VERSION_SUFFIX ""
#define 8MFM_2_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MFM_2(device_t id)
{
  ...
  move_settings.Speed = 3300;
  move_settings.uSpeed = 0;
  move_settings.Accel = 5000;
  move_settings.Decel = 5000;
  move_settings.AntiplaySpeed = 3300;
  ...
  engine_settings.NomCurrent = 116;
  engine_settings.NomSpeed = 6600;
  engine_settings.uNomSpeed = 0;
  engine_settings.EngineFlags = ENGINE_LIMIT_RPM | ENGINE_LIMIT_CURR | ENGINE_LIMIT_VOLT;
  ...
  control_settings.MaxSpeed[0] = 33;
  control_settings.MaxSpeed[1] = 330;
  control_settings.MaxSpeed[2] = 3300;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 70, 77, 45, 50, 0, 0, 0, 50, 0, 52, 55, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  stage_settings.MaxSpeed = 24;
  stage_settings.TravelRange = 90;
