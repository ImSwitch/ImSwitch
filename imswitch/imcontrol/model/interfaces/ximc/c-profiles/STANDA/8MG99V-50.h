...
#define 8MG99V_50_BUILDER_VERSION_MAJOR  0
#define 8MG99V_50_BUILDER_VERSION_MINOR  9
#define 8MG99V_50_BUILDER_VERSION_BUGFIX 10
#define 8MG99V_50_BUILDER_VERSION_SUFFIX ""
#define 8MG99V_50_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MG99V_50(device_t id)
{
  ...
  edges_settings.LeftBorder = -497;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = -391;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 71, 57, 57, 86, 45, 53, 48, 0, 0, 52, 55, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  stage_settings.LeadScrewPitch = 0.8956000208854675;
