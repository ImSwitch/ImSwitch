...
#define 8MID14_1_N_BUILDER_VERSION_MAJOR  0
#define 8MID14_1_N_BUILDER_VERSION_MINOR  9
#define 8MID14_1_N_BUILDER_VERSION_BUGFIX 10
#define 8MID14_1_N_BUILDER_VERSION_SUFFIX ""
#define 8MID14_1_N_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MID14_1_N(device_t id)
{
  ...
  edges_settings.LeftBorder = -968;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 1021;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 49, 52, 45, 49, 45, 78, 0, 0, 55, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
