...
#define 8MID15_1_H_BUILDER_VERSION_MAJOR  0
#define 8MID15_1_H_BUILDER_VERSION_MINOR  9
#define 8MID15_1_H_BUILDER_VERSION_BUGFIX 10
#define 8MID15_1_H_BUILDER_VERSION_SUFFIX ""
#define 8MID15_1_H_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MID15_1_H(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 49, 53, 45, 49, 45, 72, 0, 0, 55, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
