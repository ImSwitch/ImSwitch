#ifndef __8MID45_25_N
#define __8MID45_25_N
...
#define 8MID45_25_N_BUILDER_VERSION_MAJOR  0
#define 8MID45_25_N_BUILDER_VERSION_MINOR  9
#define 8MID45_25_N_BUILDER_VERSION_BUGFIX 10
#define 8MID45_25_N_BUILDER_VERSION_SUFFIX ""
#define 8MID45_25_N_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MID45_25_N(device_t id)
{
  ...
  edges_settings.RightBorder = 2461;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 52, 53, 45, 50, 46, 53, 45, 78, 0, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  stage_settings.TravelRange = 42.5;
