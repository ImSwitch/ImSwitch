...
#define 8MID75_4_N_BUILDER_VERSION_MAJOR  0
#define 8MID75_4_N_BUILDER_VERSION_MINOR  9
#define 8MID75_4_N_BUILDER_VERSION_BUGFIX 10
#define 8MID75_4_N_BUILDER_VERSION_SUFFIX ""
#define 8MID75_4_N_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MID75_4_N(device_t id)
{
  ...
  edges_settings.RightBorder = 9399;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 55, 53, 45, 52, 45, 78, 0, 0, 0, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  gear_settings.ReductionIn = 143;
  gear_settings.ReductionOut = 800;
