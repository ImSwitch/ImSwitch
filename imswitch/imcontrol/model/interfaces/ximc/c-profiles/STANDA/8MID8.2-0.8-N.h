#ifndef __8MID82_08_N
#define __8MID82_08_N
...
#define 8MID82_08_N_BUILDER_VERSION_MAJOR  0
#define 8MID82_08_N_BUILDER_VERSION_MINOR  9
#define 8MID82_08_N_BUILDER_VERSION_BUGFIX 10
#define 8MID82_08_N_BUILDER_VERSION_SUFFIX ""
#define 8MID82_08_N_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MID82_08_N(device_t id)
{
  ...
  edges_settings.LeftBorder = -976;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 712;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 56, 46, 50, 45, 48, 46, 56, 45, 78, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  stage_settings.TravelRange = 7.400000095367432;
