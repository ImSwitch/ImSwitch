#ifndef __8MID81_3_AR
#define __8MID81_3_AR
...
#define 8MID81_3_AR_BUILDER_VERSION_MAJOR  0
#define 8MID81_3_AR_BUILDER_VERSION_MINOR  9
#define 8MID81_3_AR_BUILDER_VERSION_BUGFIX 10
#define 8MID81_3_AR_BUILDER_VERSION_SUFFIX ""
#define 8MID81_3_AR_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MID81_3_AR(device_t id)
{
  ...
  edges_settings.LeftBorder = -243;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 9539;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 56, 49, 45, 51, 45, 65, 82, 0, 78, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  gear_settings.ReductionIn = 33;
  gear_settings.ReductionOut = 200;
