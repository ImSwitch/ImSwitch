#ifndef __8MID90_35_AR
#define __8MID90_35_AR
...
#define 8MID90_35_AR_BUILDER_VERSION_MAJOR  0
#define 8MID90_35_AR_BUILDER_VERSION_MINOR  9
#define 8MID90_35_AR_BUILDER_VERSION_BUGFIX 10
#define 8MID90_35_AR_BUILDER_VERSION_SUFFIX ""
#define 8MID90_35_AR_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MID90_35_AR(device_t id)
{
  ...
  edges_settings.LeftBorder = -236;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 9789;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 57, 48, 45, 51, 46, 53, 45, 65, 82, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  stage_settings.TravelRange = 86.5;
  ...
  gear_settings.ReductionIn = 61;
  gear_settings.ReductionOut = 400;
