...
#define 8MID98_4_N_BUILDER_VERSION_MAJOR  0
#define 8MID98_4_N_BUILDER_VERSION_MINOR  9
#define 8MID98_4_N_BUILDER_VERSION_BUGFIX 10
#define 8MID98_4_N_BUILDER_VERSION_SUFFIX ""
#define 8MID98_4_N_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MID98_4_N(device_t id)
{
  ...
  edges_settings.LeftBorder = -237;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 9765;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 57, 56, 45, 52, 45, 78, 0, 0, 82, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
