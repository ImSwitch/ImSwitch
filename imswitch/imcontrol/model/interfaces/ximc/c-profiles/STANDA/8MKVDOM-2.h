...
#define 8MKVDOM_2_BUILDER_VERSION_MAJOR  0
#define 8MKVDOM_2_BUILDER_VERSION_MINOR  9
#define 8MKVDOM_2_BUILDER_VERSION_BUGFIX 10
#define 8MKVDOM_2_BUILDER_VERSION_SUFFIX ""
#define 8MKVDOM_2_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MKVDOM_2(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 75, 86, 68, 79, 77, 45, 50, 0, 0, 0, 82, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
