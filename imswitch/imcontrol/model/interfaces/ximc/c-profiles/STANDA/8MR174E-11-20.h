#ifndef __8MR174E_11_20
#define __8MR174E_11_20
...
#define 8MR174E_11_20_BUILDER_VERSION_MAJOR  0
#define 8MR174E_11_20_BUILDER_VERSION_MINOR  9
#define 8MR174E_11_20_BUILDER_VERSION_BUGFIX 10
#define 8MR174E_11_20_BUILDER_VERSION_SUFFIX ""
#define 8MR174E_11_20_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MR174E_11_20(device_t id)
{
  ...
  home_settings.FastHome = 1000;
  home_settings.uFastHome = 0;
  home_settings.SlowHome = 10;
  home_settings.uSlowHome = 0;
  home_settings.HomeDelta = 1091;
  home_settings.uHomeDelta = 6;
  ...
  engine_settings.NomCurrent = 600;
  ...
  edges_settings.LeftBorder = -491;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 22309;
  ...
  emf_settings.L = 0.002199999988079071;
  emf_settings.R = 7.400000095367432;
  emf_settings.Km = 0.0020000000949949026;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 49, 55, 52, 69, 45, 49, 49, 45, 50, 48, 0, 69, 51, 0, 0, 0, 0, 0, 0, 0, 0};
