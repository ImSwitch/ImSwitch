#ifndef __8MR190V_2_VSS42
#define __8MR190V_2_VSS42
...
#define 8MR190V_2_VSS42_BUILDER_VERSION_MAJOR  0
#define 8MR190V_2_VSS42_BUILDER_VERSION_MINOR  9
#define 8MR190V_2_VSS42_BUILDER_VERSION_BUGFIX 10
#define 8MR190V_2_VSS42_BUILDER_VERSION_SUFFIX ""
#define 8MR190V_2_VSS42_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MR190V_2_VSS42(device_t id)
{
  ...
  home_settings.HomeFlags = HOME_USE_FAST | HOME_STOP_SECOND_REV | HOME_STOP_FIRST_BITS | HOME_DIR_SECOND | HOME_DIR_FIRST;
  ...
  move_settings.AntiplaySpeed = 50;
  ...
  power_settings.PowerFlags = POWER_SMOOTH_CURRENT | POWER_OFF_ENABLED | POWER_REDUCT_ENABLED;
  ...
  edges_settings.LeftBorder = -2400;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 20400;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 49, 57, 48, 86, 45, 50, 45, 86, 83, 83, 52, 50, 0, 0, 0, 49, 0, 0, 0, 0, 0};
