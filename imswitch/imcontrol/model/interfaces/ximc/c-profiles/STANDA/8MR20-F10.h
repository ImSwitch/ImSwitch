...
#define 8MR20_F10_BUILDER_VERSION_MAJOR  0
#define 8MR20_F10_BUILDER_VERSION_MINOR  9
#define 8MR20_F10_BUILDER_VERSION_BUGFIX 10
#define 8MR20_F10_BUILDER_VERSION_SUFFIX ""
#define 8MR20_F10_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MR20_F10(device_t id)
{
  ...
  edges_settings.LeftBorder = -17470;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 770;
  ...
  control_settings.MaxSpeed[0] = 37;
  control_settings.MaxSpeed[1] = 373;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 50, 48, 45, 70, 49, 48, 0, 83, 52, 50, 0, 52, 50, 0, 0, 49, 0, 0, 0, 0, 0};
  ...
  stage_settings.LeadScrewPitch = 6;
