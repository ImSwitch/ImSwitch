#ifndef __8MRB450_350_60D
#define __8MRB450_350_60D
...
#define 8MRB450_350_60D_BUILDER_VERSION_MAJOR  0
#define 8MRB450_350_60D_BUILDER_VERSION_MINOR  9
#define 8MRB450_350_60D_BUILDER_VERSION_BUGFIX 10
#define 8MRB450_350_60D_BUILDER_VERSION_SUFFIX ""
#define 8MRB450_350_60D_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MRB450_350_60D(device_t id)
{
  ...
  edges_settings.LeftBorder = -2395;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = -21;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 66, 52, 53, 48, 45, 51, 53, 48, 45, 54, 48, 68, 0, 77, 69, 110, 50, 0, 0, 0, 0};
