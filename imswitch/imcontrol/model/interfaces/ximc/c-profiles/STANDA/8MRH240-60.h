...
#define 8MRH240_60_BUILDER_VERSION_MAJOR  0
#define 8MRH240_60_BUILDER_VERSION_MINOR  9
#define 8MRH240_60_BUILDER_VERSION_BUGFIX 10
#define 8MRH240_60_BUILDER_VERSION_SUFFIX ""
#define 8MRH240_60_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MRH240_60(device_t id)
{
  ...
  edges_settings.LeftBorder = -104300;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = -1700;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 72, 50, 52, 48, 45, 54, 48, 0, 45, 54, 48, 68, 0, 77, 69, 110, 50, 0, 0, 0, 0};
