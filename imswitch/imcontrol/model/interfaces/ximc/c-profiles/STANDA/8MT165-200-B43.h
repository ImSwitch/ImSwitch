#ifndef __8MT165_200_B43
#define __8MT165_200_B43
...
#define 8MT165_200_B43_BUILDER_VERSION_MAJOR  0
#define 8MT165_200_B43_BUILDER_VERSION_MINOR  9
#define 8MT165_200_B43_BUILDER_VERSION_BUGFIX 10
#define 8MT165_200_B43_BUILDER_VERSION_SUFFIX ""
#define 8MT165_200_B43_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MT165_200_B43(device_t id)
{
  ...
  engine_settings.NomSpeed = 3000;
  engine_settings.uNomSpeed = 0;
  engine_settings.EngineFlags = ENGINE_LIMIT_RPM | ENGINE_LIMIT_CURR | ENGINE_ACCEL_ON | ENGINE_REVERSE;
  engine_settings.Antiplay = 25178;
  ...
  edges_settings.LeftBorder = 32833;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 1299500;
  ...
  brake_settings.BrakeFlags = BRAKE_ENG_PWROFF | BRAKE_ENABLED;
  ...
  control_settings.MaxSpeed[0] = 15;
  control_settings.MaxSpeed[1] = 150;
  control_settings.MaxSpeed[2] = 1500;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 54, 53, 45, 50, 48, 48, 45, 66, 52, 51, 0, 0, 0, 0, 48, 0, 0, 0, 0, 0};
  ...
  stage_settings.LeadScrewPitch = 3;
