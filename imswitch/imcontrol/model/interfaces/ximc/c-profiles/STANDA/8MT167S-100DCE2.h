#ifndef __8MT167S_100DCE2
#define __8MT167S_100DCE2
...
#define 8MT167S_100DCE2_BUILDER_VERSION_MAJOR  0
#define 8MT167S_100DCE2_BUILDER_VERSION_MINOR  9
#define 8MT167S_100DCE2_BUILDER_VERSION_BUGFIX 10
#define 8MT167S_100DCE2_BUILDER_VERSION_SUFFIX ""
#define 8MT167S_100DCE2_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MT167S_100DCE2(device_t id)
{
  ...
  engine_settings.NomVoltage = 2400;
  engine_settings.NomCurrent = 1500;
  engine_settings.NomSpeed = 7234;
  ...
  engine_settings.Antiplay = 31145;
  ...
  edges_settings.LeftBorder = 218731;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 8549500;
  ...
  pid_settings.KiU = 10000;
  pid_settings.KdU = 800;
  pid_settings.Kpf = 0;
  pid_settings.Kif = 0;
  pid_settings.Kdf = 0;
  ...
  control_settings.MaxSpeed[0] = 36;
  control_settings.MaxSpeed[1] = 361;
  control_settings.MaxSpeed[2] = 3617;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 54, 55, 83, 45, 49, 48, 48, 68, 67, 69, 50, 0, 83, 52, 50, 0, 0, 0, 0, 0};
  ...
  stage_settings.MaxSpeed = 5.5;
  stage_settings.TravelRange = 100;
  ...
  gear_settings.ReductionIn = 285;
  gear_settings.ReductionOut = 26;
