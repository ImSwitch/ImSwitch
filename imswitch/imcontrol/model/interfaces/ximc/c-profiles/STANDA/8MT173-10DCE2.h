#ifndef __8MT173_10DCE2
#define __8MT173_10DCE2
...
#define 8MT173_10DCE2_BUILDER_VERSION_MAJOR  0
#define 8MT173_10DCE2_BUILDER_VERSION_MINOR  9
#define 8MT173_10DCE2_BUILDER_VERSION_BUGFIX 10
#define 8MT173_10DCE2_BUILDER_VERSION_SUFFIX ""
#define 8MT173_10DCE2_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MT173_10DCE2(device_t id)
{
  ...
  engine_settings.NomCurrent = 587;
  engine_settings.NomSpeed = 8000;
  ...
  edges_settings.LeftBorder = 2319;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 166455;
  ...
  control_settings.MaxSpeed[0] = 40;
  control_settings.MaxSpeed[1] = 400;
  control_settings.MaxSpeed[2] = 4000;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 55, 51, 45, 49, 48, 68, 67, 69, 50, 0, 0, 83, 52, 50, 0, 0, 0, 0, 0, 0};
  ...
  stage_settings.MaxSpeed = 0.5;
  stage_settings.TravelRange = 10;
  ...
  encoder_settings.MaxOperatingFrequency = 8;
