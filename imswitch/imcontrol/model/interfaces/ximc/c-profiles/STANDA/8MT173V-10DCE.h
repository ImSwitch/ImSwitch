#ifndef __8MT173V_10DCE
#define __8MT173V_10DCE
...
#define 8MT173V_10DCE_BUILDER_VERSION_MAJOR  0
#define 8MT173V_10DCE_BUILDER_VERSION_MINOR  9
#define 8MT173V_10DCE_BUILDER_VERSION_BUGFIX 10
#define 8MT173V_10DCE_BUILDER_VERSION_SUFFIX ""
#define 8MT173V_10DCE_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MT173V_10DCE(device_t id)
{
  ...
  edges_settings.LeftBorder = 6576;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 332464;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 55, 51, 86, 45, 49, 48, 68, 67, 69, 0, 52, 50, 0, 51, 0, 0, 0, 0, 0, 0};
