#ifndef __8MT175_50_MEN1
#define __8MT175_50_MEN1
...
#define 8MT175_50_MEN1_BUILDER_VERSION_MAJOR  0
#define 8MT175_50_MEN1_BUILDER_VERSION_MINOR  9
#define 8MT175_50_MEN1_BUILDER_VERSION_BUGFIX 10
#define 8MT175_50_MEN1_BUILDER_VERSION_SUFFIX ""
#define 8MT175_50_MEN1_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MT175_50_MEn1(device_t id)
{
  ...
  edges_settings.LeftBorder = -126;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 18874;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 55, 53, 45, 53, 48, 45, 77, 69, 110, 49, 0, 0, 0, 51, 0, 0, 0, 0, 0, 0};
