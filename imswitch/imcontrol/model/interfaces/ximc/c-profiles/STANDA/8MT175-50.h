...
static inline result_t set_profile_8MT175_50(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 55, 53, 45, 53, 48, 0, 77, 69, 110, 49, 0, 0, 0, 51, 0, 0, 0, 0, 0, 0};
