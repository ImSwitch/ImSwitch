...
#define 8MT18_13_BUILDER_VERSION_MAJOR  0
#define 8MT18_13_BUILDER_VERSION_MINOR  9
#define 8MT18_13_BUILDER_VERSION_BUGFIX 10
#define 8MT18_13_BUILDER_VERSION_SUFFIX ""
#define 8MT18_13_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MT18_13(device_t id)
{
  ...
  engine_settings.EngineFlags = ENGINE_LIMIT_RPM | ENGINE_ACCEL_ON | ENGINE_CURRENT_AS_RMS | ENGINE_REVERSE;
  ...
  edges_settings.LeftBorder = -203;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 11089;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 56, 45, 49, 51, 0, 48, 88, 89, 90, 0, 89, 90, 0, 0, 0, 0, 0, 0, 0, 0};
