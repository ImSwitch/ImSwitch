#ifndef __8MT184_13XYZ
#define __8MT184_13XYZ
...
#define 8MT184_13XYZ_BUILDER_VERSION_MAJOR  0
#define 8MT184_13XYZ_BUILDER_VERSION_MINOR  9
#define 8MT184_13XYZ_BUILDER_VERSION_BUGFIX 10
#define 8MT184_13XYZ_BUILDER_VERSION_SUFFIX ""
#define 8MT184_13XYZ_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MT184_13XYZ(device_t id)
{
  ...
  edges_settings.LeftBorder = 60;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 9940;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 49, 56, 52, 45, 49, 51, 88, 89, 90, 0, 0, 89, 90, 0, 0, 0, 0, 0, 0, 0, 0};
