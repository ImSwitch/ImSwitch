#ifndef __8MT295X_240_25_DC
#define __8MT295X_240_25_DC
...
#define 8MT295X_240_25_DC_BUILDER_VERSION_MAJOR  0
#define 8MT295X_240_25_DC_BUILDER_VERSION_MINOR  9
#define 8MT295X_240_25_DC_BUILDER_VERSION_BUGFIX 10
#define 8MT295X_240_25_DC_BUILDER_VERSION_SUFFIX ""
#define 8MT295X_240_25_DC_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MT295X_240_25_DC(device_t id)
{
  ...
  edges_settings.LeftBorder = 4300;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 186700;
  ...
  control_settings.MaxSpeed[1] = 480;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 50, 57, 53, 88, 45, 50, 52, 48, 45, 50, 46, 53, 45, 68, 67, 0, 0, 0, 0, 0, 0};
