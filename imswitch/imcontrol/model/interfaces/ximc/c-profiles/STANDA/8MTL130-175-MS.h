#ifndef __8MTL130_175_MS
#define __8MTL130_175_MS
...
static inline result_t set_profile_8MTL130_175_MS(device_t id)
{
  ...
  home_settings.HomeDelta = 5000;
  home_settings.uHomeDelta = 0;
  home_settings.HomeFlags = HOME_STOP_SECOND_BITS | HOME_STOP_FIRST_BITS | HOME_DIR_SECOND;
  ...
  move_settings.Accel = 3000;
  move_settings.Decel = 6000;
  move_settings.AntiplaySpeed = 100;
  ...
  edges_settings.LeftBorder = 3;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 170;
  ...
  pid_settings.KiU = 0;
  pid_settings.KdU = 0;
  pid_settings.Kpf = 100;
  pid_settings.Kif = 0.12399999797344208;
  pid_settings.Kdf = 0.30000001192092896;
  ...
  stage_settings.LeadScrewPitch = 32;
  ...
  stage_settings.MaxSpeed = 400;
  stage_settings.TravelRange = 0.03500000014901161;
  stage_settings.SupplyVoltageMin = 12;
  stage_settings.SupplyVoltageMax = 48;
  stage_settings.MaxCurrentConsumption = 0;
  stage_settings.HorizontalLoadCapacity = 40;
  stage_settings.VerticalLoadCapacity = 12;
  ...
  const int8_t motor_information_Manufacturer_temp[16] = {0, 114, 117, 110, 32, 77, 105, 99, 114, 111, 101, 108, 101, 99, 116, 114};
  memcpy(motor_information.Manufacturer, motor_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t motor_information_PartNumber_temp[24] = {0, 52, 50, 46, 51, 0, 116, 100, 46, 0, 54, 0, 50, 45, 72, 86, 0, 50, 48, 48, 45, 88, 0, 0};
  ...
  const int8_t encoder_information_PartNumber_temp[24] = {0, 69, 68, 77, 45, 53, 53, 48, 48, 0, 32, 84, 121, 112, 101, 32, 77, 76, 0, 0, 0, 0, 0, 0};
  ...
  const int8_t gear_information_Manufacturer_temp[16] = {0, 65, 85, 76, 72, 65, 66, 69, 82, 0, 114, 0, 43, 32, 83, 116};
  memcpy(gear_information.Manufacturer, gear_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t gear_information_PartNumber_temp[24] = {0, 54, 47, 55, 0, 55, 0, 52, 58, 49, 0, 105, 110, 32, 116, 111, 32, 98, 97, 115, 101, 41, 0, 0};
  ...
  const int8_t accessories_settings_MagneticBrakeInfo_temp[24] = {0, 82, 65, 75, 69, 45, 66, 75, 69, 45, 48, 44, 52, 45, 48, 44, 53, 0, 0, 0, 0, 0, 0, 0};
