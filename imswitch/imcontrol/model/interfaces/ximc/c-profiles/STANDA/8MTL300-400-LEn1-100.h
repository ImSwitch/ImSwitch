#ifndef __8MTL300_400_LEN1_100
#define __8MTL300_400_LEN1_100
...
#define 8MTL300_400_LEN1_100_BUILDER_VERSION_MAJOR  0
#define 8MTL300_400_LEN1_100_BUILDER_VERSION_MINOR  9
#define 8MTL300_400_LEN1_100_BUILDER_VERSION_BUGFIX 10
#define 8MTL300_400_LEN1_100_BUILDER_VERSION_SUFFIX ""
#define 8MTL300_400_LEN1_100_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MTL300_400_LEn1_100(device_t id)
{
  ...
  feedback_settings.CountsPerTurn = 570000;
  ...
  edges_settings.LeftBorder = -1900000;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 1900000;
  ...
  control_settings.MaxSpeed[0] = 10;
  control_settings.MaxSpeed[1] = 105;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 76, 51, 48, 48, 45, 52, 48, 48, 45, 76, 69, 110, 49, 45, 49, 48, 48, 0, 0, 0, 0};
  ...
  stage_settings.LeadScrewPitch = 57;
  ...
  stage_settings.TravelRange = 400;
