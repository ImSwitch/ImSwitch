#ifndef __8MTL300_400_LEN1_25
#define __8MTL300_400_LEN1_25
...
#define 8MTL300_400_LEN1_25_BUILDER_VERSION_MAJOR  0
#define 8MTL300_400_LEN1_25_BUILDER_VERSION_MINOR  9
#define 8MTL300_400_LEN1_25_BUILDER_VERSION_BUGFIX 10
#define 8MTL300_400_LEN1_25_BUILDER_VERSION_SUFFIX ""
#define 8MTL300_400_LEN1_25_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MTL300_400_LEn1_25(device_t id)
{
  ...
  feedback_settings.CountsPerTurn = 2280000;
  ...
  home_settings.FastHome = 13;
  home_settings.uFastHome = 0;
  home_settings.SlowHome = 4;
  ...
  edges_settings.LeftBorder = -7600000;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 7600000;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 76, 51, 48, 48, 45, 52, 48, 48, 45, 76, 69, 110, 49, 45, 50, 53, 0, 0, 0, 0, 0};
