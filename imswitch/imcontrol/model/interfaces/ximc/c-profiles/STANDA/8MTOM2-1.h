...
#define 8MTOM2_1_BUILDER_VERSION_MAJOR  0
#define 8MTOM2_1_BUILDER_VERSION_MINOR  9
#define 8MTOM2_1_BUILDER_VERSION_BUGFIX 10
#define 8MTOM2_1_BUILDER_VERSION_SUFFIX ""
#define 8MTOM2_1_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MTOM2_1(device_t id)
{
  ...
  move_settings.Accel = 3762;
  move_settings.Decel = 3762;
  ...
  edges_settings.LeftBorder = -420;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 2620;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 79, 77, 50, 45, 49, 0, 48, 48, 45, 76, 69, 110, 49, 45, 53, 48, 0, 0, 0, 0, 0};
