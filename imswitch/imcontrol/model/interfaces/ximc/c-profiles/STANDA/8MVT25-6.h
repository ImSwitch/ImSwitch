...
#define 8MVT25_6_BUILDER_VERSION_MAJOR  0
#define 8MVT25_6_BUILDER_VERSION_MINOR  9
#define 8MVT25_6_BUILDER_VERSION_BUGFIX 10
#define 8MVT25_6_BUILDER_VERSION_SUFFIX ""
#define 8MVT25_6_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_8MVT25_6(device_t id)
{
  ...
  engine_settings.NomSpeed = 914;
  engine_settings.uNomSpeed = 0;
  engine_settings.EngineFlags = ENGINE_LIMIT_RPM | ENGINE_ACCEL_ON | ENGINE_CURRENT_AS_RMS;
  engine_settings.Antiplay = 169;
  ...
  edges_settings.LeftBorder = -226;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 10197;
  ...
  control_settings.MaxSpeed[1] = 457;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 86, 84, 50, 53, 45, 54, 0, 48, 0, 50, 52, 55, 0, 0, 45, 53, 48, 0, 0, 0, 0, 0};
  ...
  stage_settings.LeadScrewPitch = 0.3499999940395355;
