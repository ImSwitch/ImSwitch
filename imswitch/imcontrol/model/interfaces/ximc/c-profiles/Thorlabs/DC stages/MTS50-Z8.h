...
#define MTS50_Z8_BUILDER_VERSION_MAJOR  0
#define MTS50_Z8_BUILDER_VERSION_MINOR  9
#define MTS50_Z8_BUILDER_VERSION_BUGFIX 9
#define MTS50_Z8_BUILDER_VERSION_SUFFIX ""
#define MTS50_Z8_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_MTS50_Z8(device_t id)
{
  ...
  engine_settings.NomCurrent = 156;
  engine_settings.NomSpeed = 6560;
  ...
  edges_settings.LeftBorder = 40880;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 1670320;
  ...
  control_settings.MaxSpeed[2] = 1050;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {77, 84, 83, 53, 48, 45, 90, 56, 0, 45, 49, 0, 52, 55, 0, 0, 45, 53, 48, 0, 0, 0, 0, 0};
  ...
  stage_settings.MaxSpeed = 2.4000000953674316;
