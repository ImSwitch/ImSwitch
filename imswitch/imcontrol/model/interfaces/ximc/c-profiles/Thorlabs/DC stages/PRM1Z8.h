...
#define PRM1Z8_BUILDER_VERSION_MAJOR  0
#define PRM1Z8_BUILDER_VERSION_MINOR  9
#define PRM1Z8_BUILDER_VERSION_BUGFIX 9
#define PRM1Z8_BUILDER_VERSION_SUFFIX ""
#define PRM1Z8_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_PRM1Z8(device_t id)
{
  ...
  feedback_settings.CountsPerTurn = 512;
  ...
  home_settings.HomeDelta = 439673;
  ...
  move_settings.Speed = 2812;
  move_settings.uSpeed = 0;
  move_settings.Accel = 7000;
  move_settings.Decel = 7000;
  move_settings.AntiplaySpeed = 2812;
  ...
  engine_settings.NomCurrent = 125;
  engine_settings.NomSpeed = 5624;
  engine_settings.uNomSpeed = 0;
  engine_settings.EngineFlags = ENGINE_LIMIT_RPM | ENGINE_LIMIT_VOLT | ENGINE_ACCEL_ON | ENGINE_REVERSE;
  engine_settings.Antiplay = 14438;
  engine_settings.MicrostepMode = MICROSTEP_MODE_FULL;
  engine_settings.StepsPerRev = 512;
  ...
  edges_settings.LeftBorder = -422396;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 234149;
  ...
  pid_settings.KpU = 8000;
  pid_settings.KiU = 28000;
  pid_settings.KdU = 16000;
  pid_settings.Kpf = 0;
  pid_settings.Kif = 0;
  pid_settings.Kdf = 0;
  ...
  control_settings.MaxSpeed[0] = 28;
  control_settings.MaxSpeed[1] = 281;
  control_settings.MaxSpeed[2] = 2812;
  ...
  ctp_settings.CTPFlags = CTP_ERROR_CORRECTION | CTP_ENABLED;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {80, 82, 77, 49, 90, 56, 0, 56, 0, 45, 49, 0, 52, 55, 0, 0, 45, 53, 48, 0, 0, 0, 0, 0};
  ...
  stage_settings.LeadScrewPitch = 18;
  ...
  gear_settings.ReductionIn = 185193;
  gear_settings.ReductionOut = 2744;
