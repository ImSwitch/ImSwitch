...
#define LNR25ZFS_BUILDER_VERSION_MAJOR  0
#define LNR25ZFS_BUILDER_VERSION_MINOR  9
#define LNR25ZFS_BUILDER_VERSION_BUGFIX 9
#define LNR25ZFS_BUILDER_VERSION_SUFFIX ""
#define LNR25ZFS_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_LNR25ZFS(device_t id)
{
  ...
  home_settings.FastHome = 533;
  home_settings.uFastHome = 0;
  home_settings.SlowHome = 533;
  home_settings.uSlowHome = 0;
  home_settings.HomeDelta = 533;
  ...
  move_settings.Speed = 1066;
  move_settings.uSpeed = 0;
  move_settings.Accel = 533;
  move_settings.Decel = 533;
  move_settings.AntiplaySpeed = 1066;
  ...
  edges_settings.LeftBorder = 134;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 25467;
  ...
  control_settings.MaxSpeed[1] = 106;
  control_settings.MaxSpeed[2] = 1066;
  ...
  const int8_t stage_information_PartNumber_temp[24] = {76, 78, 82, 50, 53, 90, 70, 83, 0, 45, 49, 0, 52, 55, 0, 0, 45, 53, 48, 0, 0, 0, 0, 0};
  ...
  gear_settings.ReductionIn = 400;
  gear_settings.ReductionOut = 9;
