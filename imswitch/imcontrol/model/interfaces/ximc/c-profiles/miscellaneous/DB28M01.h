...
#define DB28M01_BUILDER_VERSION_MAJOR  0
#define DB28M01_BUILDER_VERSION_MINOR  9
#define DB28M01_BUILDER_VERSION_BUGFIX 10
#define DB28M01_BUILDER_VERSION_SUFFIX ""
#define DB28M01_BUILDER_VERSION        "0.9.10"
...
static inline result_t set_profile_DB28M01(device_t id)
{
  ...
  feedback_settings.CountsPerTurn = 2000;
  ...
  move_settings.Speed = 6500;
  move_settings.uSpeed = 0;
  move_settings.Accel = 24000;
  move_settings.Decel = 30000;
  move_settings.AntiplaySpeed = 6500;
  ...
  edges_settings.LeftBorder = -701000;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = -17000;
  ...
  pid_settings.KdU = 0;
  pid_settings.Kpf = 2;
  pid_settings.Kif = 0.0078125;
  pid_settings.Kdf = 0.015625;
  ...
  control_settings.MaxSpeed[0] = 65;
  control_settings.MaxSpeed[1] = 650;
  control_settings.MaxSpeed[2] = 6500;
