...
static inline result_t set_profile_FL57STH76(device_t id)
{
  ...
  engine_settings.NomCurrent = 2800;
  ...
  edges_settings.LeftBorder = -58200;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 10200;
