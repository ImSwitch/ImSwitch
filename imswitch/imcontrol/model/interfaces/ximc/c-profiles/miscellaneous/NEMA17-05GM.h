#ifndef __NEMA17_05GM
#define __NEMA17_05GM
...
static inline result_t set_profile_NEMA17_05GM(device_t id)
{
  ...
  engine_settings.NomVoltage = 280;
  engine_settings.NomCurrent = 1680;
  ...
  edges_settings.LeftBorder = 11025;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = 11975;
