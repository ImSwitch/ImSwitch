#ifndef __ST5909L3008
#define __ST5909L3008
...
static inline result_t set_profile_ST5909L3008(device_t id)
{
  ...
  edges_settings.LeftBorder = -139400;
  edges_settings.uLeftBorder = 0;
  edges_settings.RightBorder = -2600;
