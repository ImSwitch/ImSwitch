def set_profile_UTS100CC(lib, id):
    ...
    class BorderFlags_:
        ...
        BORDER_STOP_LEFT = 2
        BORDER_IS_ENCODER = 1
    edges_settings.BorderFlags = BorderFlags_.BORDERS_SWAP_MISSET_DETECTION | BorderFlags_.BORDER_STOP_RIGHT | BorderFlags_.BORDER_STOP_LEFT
    class EnderFlags_:
    ...
    stage_information.PartNumber = bytes([85, 84, 83, 49, 48, 48, 67, 67, 0, 45, 48, 54, 0, 45, 48, 52, 0, 0, 0, 0, 0, 0, 0, 0])
