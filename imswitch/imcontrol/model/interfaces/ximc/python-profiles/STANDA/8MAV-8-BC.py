def set_profile_8MAV_8_BC(lib, id):
    ...
    class HomeFlags_:
        ...
        HOME_DIR_SECOND = 2
        HOME_DIR_FIRST = 1
    home_settings.HomeFlags = HomeFlags_.HOME_STOP_SECOND_REV | HomeFlags_.HOME_STOP_FIRST_BITS | HomeFlags_.HOME_DIR_SECOND
    ...
    stage_information.PartNumber = bytes([56, 77, 65, 86, 45, 56, 45, 66, 67, 0, 50, 52, 55, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0])
