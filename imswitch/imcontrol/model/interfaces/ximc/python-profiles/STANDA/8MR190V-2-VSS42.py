def set_profile_8MR190V_2_VSS42(lib, id):
    ...
    class HomeFlags_:
        ...
        HOME_DIR_SECOND = 2
        HOME_DIR_FIRST = 1
    home_settings.HomeFlags = HomeFlags_.HOME_USE_FAST | HomeFlags_.HOME_STOP_SECOND_REV | HomeFlags_.HOME_STOP_FIRST_BITS | HomeFlags_.HOME_DIR_SECOND | HomeFlags_.HOME_DIR_FIRST
    ...
    stage_information.PartNumber = bytes([56, 77, 82, 49, 57, 48, 86, 45, 50, 45, 86, 83, 83, 52, 50, 0, 0, 0, 49, 0, 0, 0, 0, 0])
