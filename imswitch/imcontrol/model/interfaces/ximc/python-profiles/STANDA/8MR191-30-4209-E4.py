def set_profile_8MR191_30_4209_E4(lib, id):
    ...
    class HomeFlags_:
        ...
        HOME_DIR_SECOND = 2
        HOME_DIR_FIRST = 1
    home_settings.HomeFlags = HomeFlags_.HOME_USE_FAST | HomeFlags_.HOME_STOP_SECOND_REV | HomeFlags_.HOME_STOP_FIRST_BITS | HomeFlags_.HOME_MV_SEC_EN | HomeFlags_.HOME_DIR_FIRST
    ...
    class CTPFlags_:
        ...
        CTP_BASE = 2
        CTP_ENABLED = 1
    ctp_settings.CTPFlags = CTPFlags_.CTP_BASE | CTPFlags_.CTP_ENABLED
    ...
    stage_information.PartNumber = bytes([56, 77, 82, 49, 57, 49, 45, 51, 48, 45, 52, 50, 48, 57, 45, 69, 52, 0, 49, 0, 0, 0, 0, 0])
