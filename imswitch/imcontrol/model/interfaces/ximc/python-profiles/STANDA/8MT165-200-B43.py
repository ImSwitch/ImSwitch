def set_profile_8MT165_200_B43(lib, id):
    ...
    class EngineFlags_:
        ...
        ENGINE_REVERSE = 1
    engine_settings.EngineFlags = EngineFlags_.ENGINE_LIMIT_RPM | EngineFlags_.ENGINE_LIMIT_CURR | EngineFlags_.ENGINE_ACCEL_ON | EngineFlags_.ENGINE_REVERSE
