def set_profile_8MT18_13(lib, id):
    ...
    class EngineFlags_:
        ...
        ENGINE_REVERSE = 1
    engine_settings.EngineFlags = EngineFlags_.ENGINE_LIMIT_RPM | EngineFlags_.ENGINE_ACCEL_ON | EngineFlags_.ENGINE_CURRENT_AS_RMS | EngineFlags_.ENGINE_REVERSE
    ...
    stage_information.PartNumber = bytes([56, 77, 84, 49, 56, 45, 49, 51, 0, 48, 88, 89, 90, 0, 89, 90, 0, 0, 0, 0, 0, 0, 0, 0])
