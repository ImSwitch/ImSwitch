def set_profile_8MT184V_13DC(lib, id):
    ...
    edges_settings.LeftBorder = 10949
    edges_settings.uLeftBorder = 0
    edges_settings.RightBorder = 434603
    ...
    stage_information.PartNumber = bytes([56, 77, 84, 49, 56, 52, 86, 45, 49, 51, 68, 67, 0, 0, 89, 90, 0, 0, 0, 0, 0, 0, 0, 0])
