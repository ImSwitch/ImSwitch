def set_profile_8MTF200XY_B43_LEn1_100(lib, id):
    ...
    stage_information.PartNumber = bytes([56, 77, 84, 70, 50, 48, 48, 88, 89, 45, 66, 52, 51, 45, 76, 69, 110, 49, 45, 49, 48, 48, 0, 0])
