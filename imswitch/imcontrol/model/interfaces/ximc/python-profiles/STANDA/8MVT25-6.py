def set_profile_8MVT25_6(lib, id):
    ...
    class EngineFlags_:
        ...
        ENGINE_REVERSE = 1
    engine_settings.EngineFlags = EngineFlags_.ENGINE_LIMIT_RPM | EngineFlags_.ENGINE_ACCEL_ON | EngineFlags_.ENGINE_CURRENT_AS_RMS
    ...
    stage_information.PartNumber = bytes([56, 77, 86, 84, 50, 53, 45, 54, 0, 48, 0, 50, 52, 55, 0, 0, 45, 53, 48, 0, 0, 0, 0, 0])
