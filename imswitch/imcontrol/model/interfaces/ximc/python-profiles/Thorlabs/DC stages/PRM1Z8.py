def set_profile_PRM1Z8(lib, id):
    ...
    class EngineFlags_:
        ...
        ENGINE_REVERSE = 1
    engine_settings.EngineFlags = EngineFlags_.ENGINE_LIMIT_RPM | EngineFlags_.ENGINE_LIMIT_VOLT | EngineFlags_.ENGINE_ACCEL_ON | EngineFlags_.ENGINE_REVERSE
    ...
    stage_information.PartNumber = bytes([80, 82, 77, 49, 90, 56, 0, 56, 0, 45, 49, 0, 52, 55, 0, 0, 45, 53, 48, 0, 0, 0, 0, 0])
