def set_profile_NEMA17_05GM(lib, id):
    ...
    class EngineFlags_:
        ...
        ENGINE_REVERSE = 1
    engine_settings.EngineFlags = EngineFlags_.ENGINE_ACCEL_ON
    ...
    stage_information.PartNumber = bytes([78, 69, 77, 65, 49, 55, 45, 48, 53, 71, 77, 0, 53, 45, 48, 52, 0, 0, 0, 0, 0, 0, 0, 0])
