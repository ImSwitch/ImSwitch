...
class ImConMainView(QMainWindow):
    ...
    def __init__(self, options, viewSetupInfo, *args, **kwargs):
        ...
        # Dock area
        rightDockInfos = {
            'Shutter': _DockInfo(name='Shutter', yPosition=0),
            ...
            'Laser': _DockInfo(name='Laser Control', yPosition=1),
            'LED': _DockInfo(name='LED Control', yPosition=0),
            'EtSTED': _DockInfo(name='EtSTED', yPosition=1),
            'Positioner': _DockInfo(name='Positioner', yPosition=2),
            'Rotator': _DockInfo(name='Rotator', yPosition=2),
            'MotCorr': _DockInfo(name='Motorized Correction Collar', yPosition=2),
            'StandaPositioner': _DockInfo(name='StandaPositioner', yPosition=1),
            'StandaStage': _DockInfo(name='StandaStage', yPosition=1),
            'SLM': _DockInfo(name='SLM', yPosition=3),
            ...
            'RotationScan': _DockInfo(name='RotationScan', yPosition=3),
